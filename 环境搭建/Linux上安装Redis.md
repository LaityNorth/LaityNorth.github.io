...
redis各个版本下载：[Reids版本](http://download.redis.io/releases/)
...
修改redis.conf配置文件,然后指定配置文件启动redis

修改内容如下:
>[!DANGER]将reids配置文件的daemonize修改为yes,requirepass设置密码,bind允许公网远程访问
>```properties
>daemonize yes
...
OK
127.0.0.1:6379> set name feifei
OK
